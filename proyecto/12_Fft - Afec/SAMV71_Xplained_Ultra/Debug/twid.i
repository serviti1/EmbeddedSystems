# 1 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
...
# 1 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
# 34 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
...
# 35 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 37 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c" 2
...
static void TWID_DmaInitializeWrite(TwihsDma *pTwiXdma)
{
 ...
 dmaWriteChannel = XDMAD_AllocateChannel( pTwiXdma->pTwiDma, 0xFF,
   pTwiXdma->Twi_id);
 if ( dmaWriteChannel == 0xFFFF ) {
  printf("-E- Can't allocate XDMA channel\n\r");
 }
...
static uint8_t TWID_XdmaConfigureWrite(TwihsDma *pTwiXdma, uint8_t *buf, uint32_t len)
{
 ...
 Thr = (uint32_t)&(((Twihs *)0x40018000U)->TWIHS_THR);
 if(pTwiXdma->Twi_id==(20)) {
  Thr = (uint32_t)&(((Twihs *)0x4001C000U)->TWIHS_THR);
 }
 if(pTwiXdma->Twi_id==(41)) {
  Thr = (uint32_t)&(((Twihs *)0x40060000U)->TWIHS_THR);
 }
 xdmadTxCfg.mbr_ubc = (0x0u << 27) |
        (0x0u << 24)|
        (0x1u << 25) | len;

 xdmadTxCfg.mbr_sa = (uint32_t)buf;
 xdmadTxCfg.mbr_da = Thr;
 xdmadTxCfg.mbr_cfg = (0x1u << 0) |
       (0x0u << 1) |
       (0x1u << 4) |
       (0x0u << 8) |
       (0x0u << 11)|
       ...
       (0x1u << 16) |
       (0x0u << 18) |
       (((0x7fu << 24) & ((XDMAIF_Get_ChannelNumber( pTwiXdma->Twi_id, 0 )) << 24)))
                                             ;
...
static uint8_t TWID_XdmaConfigureRead(TwihsDma *pTwiXdma, uint8_t *buf, uint32_t len)
{
 ...
 Rhr = (uint32_t)&(((Twihs *)0x40018000U)->TWIHS_RHR);
 if(pTwiXdma->Twi_id==(20)) {
  Rhr = (uint32_t)&(((Twihs *)0x4001C000U)->TWIHS_RHR);
 }
 if(pTwiXdma->Twi_id==(41)) {
  Rhr = (uint32_t)&(((Twihs *)0x40060000U)->TWIHS_RHR);
 }
 xdmadRxCfg.mbr_ubc = (0x0u << 27) |
        (0x0u << 24)|
        (0x1u << 26) |
        len;
 ...
 xdmadRxCfg.mbr_cfg = (0x1u << 0) |
         ...
         (0x0u << 16) |
         (0x1u << 18) |
         (((0x7fu << 24) & ((XDMAIF_Get_ChannelNumber( pTwiXdma->Twi_id , 1 )) << 24)))
                                               ;
...
# 201 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
uint32_t ASYNC_IsFinished( Async* pAsync )
{
 return (pAsync->status != 0xFF) ;
}
# 213 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
void TWID_Initialize(Twid *pTwid, Twihs *pTwi)
{
 { } ;
 ((pTwid != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 216, __FUNCTION__, "pTwid != NULL")) ;
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 217, __FUNCTION__, "pTwi != NULL")) ;
...
void TWID_Handler( Twid *pTwid )
{
 ...
 ((pTwid != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 236, __FUNCTION__, "pTwid != NULL")) ;

 pTransfer = (AsyncTwi*)pTwid->pTransfer ;
 ((pTransfer != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 239, __FUNCTION__, "pTransfer != NULL")) ;
 pTwi = pTwid->pTwi ;
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 241, __FUNCTION__, "pTwi != NULL")) ;
 ...
 if (((status & (0x1u << 1)) == (0x1u << 1))) {
  ...
  if (pTransfer->transferred == pTransfer->num) {
   ...
   TWI_DisableIt(pTwi, (0x1u << 1));
   TWI_EnableIt(pTwi, (0x1u << 0));
  }
...
# 305 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
uint8_t TWID_Read(
  Twid *pTwid,
  uint8_t address,
  uint32_t iaddress,
  ...
  Async *pAsync)
{
 ...
 AsyncTwi *pTransfer;
 uint32_t startTime;
 ((pTwid != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 317, __FUNCTION__, "pTwid != NULL")) ;
 pTwi = pTwid->pTwi;
 pTransfer = (AsyncTwi *) pTwid->pTransfer;

 (((address & 0x80) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 321, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 322, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 323, __FUNCTION__, "isize < 4")) ;


 if (pTransfer) {

  { printf("-E- " "TWID_Read: A transfer is already pending\n\r"); };
  return 1;
 }
 ...
 if (pAsync) {
  ...
  pTransfer->status = 0xFF;
  pTransfer->pData = pData;
  pTransfer->num = num;
  pTransfer->transferred = 0;


  TWI_EnableIt(pTwi, (0x1u << 1));
  ...
  while (num > 0) {
   ...
   while( !TWI_ByteReceived(pTwi)) {
    if ( (GetDelayInTicks(startTime, GetTicks() ) ) > 400) {
     { printf("-E- " "TWID Timeout BR\n\r"); };
     break;
    }
   }
...
# 403 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
uint8_t TWID_Write(
  Twid *pTwid,
  uint8_t address,
  uint32_t iaddress,
  ...
  Async *pAsync)
{
 ...
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 416, __FUNCTION__, "pTwi != NULL")) ;
 (((address & 0x80) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 417, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 418, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 419, __FUNCTION__, "isize < 4")) ;


 if (pTransfer) {
  { printf("-E- " "TWI_Write: A transfer is already pending\n\r"); };
  return 1;
 }
...
# 480 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
void TWID_DmaInitialize(TwihsDma *pTwidma, Twihs *pTwi, uint8_t bPolling)
{
 { } ;
 ((pTwidma != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 483, __FUNCTION__, "pTwidma != NULL")) ;

 if ((unsigned int)pTwi == (unsigned int)((Twihs *)0x40018000U) ) pTwidma->Twi_id = (19);
 if ((unsigned int)pTwi == (unsigned int)((Twihs *)0x4001C000U) ) pTwidma->Twi_id = (20);
 if ((unsigned int)pTwi == (unsigned int)((Twihs *)0x40060000U) ) pTwidma->Twi_id = (41);
...
# 517 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
  ...
  Async *pAsync)
{
 ...
 ((pTwiXdma->pTwid != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 530, __FUNCTION__, "pTwiXdma->pTwid != NULL")) ;
 pTwi = pTwiXdma->pTwid->pTwi;
 pTransfer = (AsyncTwi *) pTwiXdma->pTwid->pTransfer;

 (((address & 0x80) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 534, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 535, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 536, __FUNCTION__, "isize < 4")) ;
...
# 629 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c"
  ...
  Async *pAsync)
{
 ...
 ((pTwi != ((void *)0)) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 642, __FUNCTION__, "pTwi != NULL")) ;
 (((address & 0x80) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 643, __FUNCTION__, "(address & 0x80) == 0")) ;
 (((iaddress & 0xFF000000) == 0) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 644, __FUNCTION__, "(iaddress & 0xFF000000) == 0")) ;
 ((isize < 4) ? (void)0 : __assert_func ("C:\\SAMV71x\\hal\\libchip_samv7\\source\\twid.c", 645, __FUNCTION__, "isize < 4")) ;
