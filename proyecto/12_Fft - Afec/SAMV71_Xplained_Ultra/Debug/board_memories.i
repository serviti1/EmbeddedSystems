# 1 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_memories.c"
...
# 1 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_memories.c"
# 40 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_memories.c"
...
# 41 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_memories.c" 2
...
{
 const Pin pinsSdram[] = {{0x000000FF, ((Pio *)0x400E1200U), (12), 0, (0 << 0)}, {0x0000003F, ((Pio *)0x400E1600U), (17), 0, (0 << 0)} , {0x00018000, ((Pio *)0x400E0E00U), (10), 0, (0 << 0)}, {0x3FF00000, ((Pio *)0x400E1200U), (12), 0, (0 << 0)}, {0x00002000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)}, {0x00100000, ((Pio *)0x400E0E00U), (10), 2, (0 << 0)}, {0x00020000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)}, {0x00010000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)}, {0x00004000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)},{0x00800000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)}, {0x00008000, ((Pio *)0x400E1200U), (12), 0, (0 << 0)},{0x00040000, ((Pio *)0x400E1200U), (12), 0, (0 << 0)} ,{0x00008000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)},{0x20000000, ((Pio *)0x400E1400U), (16), 2, (0 << 0)}};
 volatile uint32_t i;
 volatile uint8_t *pSdram = (uint8_t *) (0x70000000u);


 PIO_Configure(pinsSdram, (sizeof(pinsSdram) / sizeof(Pin)));
 PMC_EnablePeripheral((62));
 ((Matrix *)0x40088000U)->CCFG_SMCNFCS = (0x1u << 4);




 ((Sdramc *)0x40084000U)->SDRAMC_CR =
    (0x0u << 0)
  | (0x0u << 2)
  | (0x2u << 5)
  | (0x0u << 4)
 ...
 ((Sdramc *)0x40084000U)->SDRAMC_MDR = (0x0u << 0);
 ...
 ((Sdramc *)0x40084000U)->SDRAMC_MR = (0x1u << 0);
 *pSdram = 0;
 for (i = 0; i < 100000; i++);



 ((Sdramc *)0x40084000U)->SDRAMC_MR = (0x2u << 0);
 *pSdram = 0;
 for (i = 0; i < 100000; i++);
 ...
 for (i = 0 ; i< 8; i++) {
  ((Sdramc *)0x40084000U)->SDRAMC_MR = (0x4u << 0);
  *pSdram = 0;
 }
 for (i = 0; i < 100000; i++);
 ...
 ((Sdramc *)0x40084000U)->SDRAMC_MR = (0x3u << 0);
 *pSdram = 0;

 for (i = 0; i < 100000; i++);
# 217 "C:\\SAMV71x\\bsp\\libboard_samv7-ek\\source\\board_memories.c"
 ((Sdramc *)0x40084000U)->SDRAMC_MR = (0x0u << 0);
 *pSdram = 0;
 for (i = 0; i < 100000; i++);
 ...
 ((Sdramc *)0x40084000U)->SDRAMC_TR = 2343; ;
 ((Sdramc *)0x40084000U)->SDRAMC_CFR1 |= (0x1u << 8);
