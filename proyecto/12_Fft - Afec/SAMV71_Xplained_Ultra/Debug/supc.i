# 1 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c"
...
# 1 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c"
# 34 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c"
...
# 35 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 37 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c" 2
# 47 "C:\\SAMV71x\\hal\\libchip_samv7\\source\\supc.c"
void SUPC_SelectExtCrystal32K(void)
{
 PMC_EnableXT32KFME();
...
void SUPC_DisableVoltageReg(void)
{
 ((Supc *)0x400E1810U)->SUPC_CR |= (0xA5u << 24) | (0x1u << 2);
}
...
void SUPC_ConfigSupplyMonitor(uint32_t Config)
{
 ((Supc *)0x400E1810U)->SUPC_SMMR = Config;
}
...
void SUPC_DisableSupplyMonitor(void)
{
 ((Supc *)0x400E1810U)->SUPC_SMMR = (0x0u << 8);
}
...
{
 if(enable) {
  ((Supc *)0x400E1810U)->SUPC_MR = ( (0x0u << 13) | (0xA5u << 24));
 } else {
  ((Supc *)0x400E1810U)->SUPC_MR = ( (0x1u << 13) | (0xA5u << 24));
 }
}
...
void SUPC_BrownoutResetEnable(void)
{
 ((Supc *)0x400E1810U)->SUPC_MR = ( (0x1u << 12) | (0xA5u << 24));
}
...
{
 if(enable) {
  ((Supc *)0x400E1810U)->SUPC_MR = ((1 << 17) | (0xA5u << 24));
 } else {
  ((Supc *)0x400E1810U)->SUPC_MR = ( (0 << 17) | (0xA5u << 24));
 }
}
...
void SUPC_BypassXtal32KOsc(void)
{
 ((Supc *)0x400E1810U)->SUPC_MR = ( (0x1u << 20) | (0xA5u << 24));
}
...
{
 if(enable) {
  ((Supc *)0x400E1810U)->SUPC_WUMR |= Regs;
 } else {
  ((Supc *)0x400E1810U)->SUPC_WUMR &= ~(uint32_t)Regs;
 }
}
...
void SUPC_SetWakeupDebounce(uint8_t period)
{
 ((Supc *)0x400E1810U)->SUPC_WUMR |= ( (period << 12) & (0x7u << 12));
}
...
void SUPC_SetLowPowerDebounce(uint8_t period)
{
 ((Supc *)0x400E1810U)->SUPC_WUMR |= ( (period << 16) & (0x7u << 16));
}
...
{
 if(enable) {
  ((Supc *)0x400E1810U)->SUPC_WUIR |= Input;
 } else {
  ((Supc *)0x400E1810U)->SUPC_WUIR &= ~(uint32_t)Input;
 }
}
...
uint8_t SUPC_IsSlowClkExtCrystal32K(void)
{
 return ((((Supc *)0x400E1810U)->SUPC_SR & (0x1u << 7)) >> 7);
}
...
uint8_t SUPC_Read_Status(uint32_t status)
{
 return (((Supc *)0x400E1810U)->SUPC_SR & status);
}
