...
tSchedulingTask Tasks[TASK_SCH_MAX_NUMBER_TASKS] =
{
    {EVENT_TASK, TASK_BUTTON0_EVENT, SUSPENDED, TASKS_PRIORITY_5},
    {TASK_NULL, NULL, SUSPENDED, TASKS_PRIORITY_1},
    {TASK_NULL, NULL, SUSPENDED, TASKS_PRIORITY_1},
    {TASK_NULL, NULL, SUSPENDED, TASKS_PRIORITY_1},
    {TASK_NULL, NULL, SUSPENDED, TASKS_PRIORITY_1},
};
...
/*******************************************************************************/
/**
* \brief    Task schedule point that will enable the  Cooperative Scheduler.
* \author   Jesus Cinco & Snaider Bautista
* \param    void
* \return   void
* \todo
*/
...
void vfnSchedulePoint(void){
    uint8_t i;
    for(i = 0; i < TASK_SCH_MAX_NUMBER_TASKS; i++){
